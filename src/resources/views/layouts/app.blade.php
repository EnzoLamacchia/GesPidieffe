            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative" x-data="{ open: false }" @@click.outside="open = false">
                    ...
                    <div x-show="open" x-transition
                        ...
                        <a href="{{ route('gespidieffe.unisciorganizza') }}" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"><span style="color:#f97316">●</span> Unisci e Organizza</a>
                        <a href="{{ route('gespidieffe.pdf2word') }}"      class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"><span style="color:#0d9488">●</span> PDF to Word</a>
